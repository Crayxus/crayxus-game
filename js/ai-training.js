...
const AITraining = {
  ...
  // 段位系统
  RANKS: [
    { name: '入门一级', icon: '🥉', min: 0,    color: '#cd7f32' },
    { name: '入门二级', icon: '🥉', min: 600,  color: '#cd7f32' },
    { name: '入门三级', icon: '🥉', min: 750,  color: '#cd7f32' },
    { name: '初级一段', icon: '🥈', min: 900,  color: '#c0c0c0' },
    { name: '初级二段', icon: '🥈', min: 1000, color: '#c0c0c0' },
    { name: '初级三段', icon: '🥈', min: 1100, color: '#c0c0c0' },
    { name: '中级一段', icon: '🥇', min: 1200, color: '#ffd700' },
    { name: '中级二段', icon: '🥇', min: 1350, color: '#ffd700' },
    { name: '中级三段', icon: '🥇', min: 1500, color: '#ffd700' },
    { name: '高级一段', icon: '💎', min: 1650, color: '#00e5ff' },
    { name: '高级二段', icon: '💎', min: 1800, color: '#00e5ff' },
    { name: '高级三段', icon: '💎', min: 1950, color: '#00e5ff' },
    { name: '掼蛋大师', icon: '👑', min: 2100, color: '#ff6b35' },
  ],
