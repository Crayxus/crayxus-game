  ...
  COURSES: [
    {
      ...
      desc: '学会用最少的手数出完牌',
      lessons: [
        { id: 1, name: '认识牌型', desc: '单牌、对子、三条、顺子' },
        { id: 2, name: '基础组牌', desc: '简单手牌的最优分解' },
        { id: 3, name: '顺子优先', desc: '什么时候该凑顺子' },
        { id: 4, name: '三带二策略', desc: '三条+对子的组合技巧' },
        { id: 5, name: '高级分解', desc: '复杂手牌的多种分解路线' },
      ]
    },
    {
      id: 'power',
      ...
      lessons: [
        ...
        { id: 4, name: '大牌留守', desc: '保留大牌做防守' },
        { id: 5, name: '控场节奏', desc: '大牌的高级运用' },
      ]
    },
    {
      id: 'timing',
      ...
      lessons: [
        ...
        { id: 2, name: '顺势而为', desc: '利用对手的出牌消自己的牌' },
        { id: 3, name: '忍耐的艺术', desc: '什么时候该 PASS' },
        { id: 4, name: '主动出击', desc: '抢先出牌的时机' },
        { id: 5, name: '节奏掌控', desc: '控制全局的出牌节奏' },
      ]
    },
    {
      id: 'teamwork',
      ...
      lessons: [
        ...
        { id: 3, name: '帮队友走完', desc: '队友快走完时怎么帮' },
        { id: 4, name: '读懂信号', desc: '从队友出牌推断意图' },
        { id: 5, name: '默契配合', desc: '高级团队策略' },
      ]
    },
    {
      id: 'bomb',
      ...
      lessons: [
        ...
        { id: 4, name: '炸弹留存', desc: '多个炸弹的使用顺序' },
        { id: 5, name: '炸弹博弈', desc: '对手也有炸弹时怎么办' },
      ]
    },
    {
      id: 'endgame',
      ...
      desc: '最后几张牌决定胜负',
      lessons: [
        { id: 1, name: '收尾基础', desc: '2-3张牌的出牌顺序' },
        { id: 2, name: '对子收尾', desc: '用对子结束战斗' },
        { id: 3, name: '三带二收尾', desc: '一手走完的技巧' },
        { id: 4, name: '残局计算', desc: '4-5张牌的最优路线' },
        { id: 5, name: '逆风翻盘', desc: '困难局面的终局策略' },
      ]
    },
  ],
