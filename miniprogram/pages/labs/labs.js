...
const PROJECTS = [
  ...
  },
  {
    ...
    benefits: [
      ...
      { icon: '🧬', t: '编码 SaaS 终身授权 + 跨行业可用', d: '服装 / 电子 / 汽车 / 家具 4 大行业 ERP 接入 · 终身免费用' },
      { icon: '💎', t: '未来营收分润权 2.5% + NFT 凭证', d: 'AAAS 系统 SaaS 化期内 享 2.5% 营收分润（年营收预估 1500w+）按年兑付' },
  ...
  },
  {
    ...
    color: '#10b981',
    name: 'AI 氢能源生态大脑',
    short: '制氢 / 储氢 / 加氢站 / 燃料电池 全链调度 SaaS',
    budget: 800,
    duration: 12,
    seats: 10,
    joined: 2,
