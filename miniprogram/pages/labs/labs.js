...
const PROJECTS = [
  ...
  },
  {
    ...
    perSeat: 15,
    seatUnit: '万',
    tagline: '法良时装（26 个国际品牌）已落地的 AAAS · 服装产业大脑 + 跨行业 8 位标准物料编码 一体化',
    painpoint: '中国高端代工厂年均流转 1000+ 款，每款几十种辅料 — 拉链 A 厂叫 "YKK 5# 黑"、B 厂叫 "5号YKK黑色"、C 厂又叫 "Vislon 黑"，ERP 入库重复浪费仓位、采购员靠脑记跟单不愿用 ERP。我们做完整 6 智能体（采购跟单 / 物料标准化 / 供应商评估 / 翻译 / 8 位标准编码 / 跨行业归一）让 AI 一次解决服装产业从订单到物料编码全链路，并输出可复用到电子/汽车/家具行业的标准编码引擎。',
    tech: 'DeepSeek V4 + 21 年法良物料库 + 26 品牌 BOM + 行业字典 + 8 位编码规则引擎 (如 YK-5C-OH-PL) + 描述归一化模型 + ERP/SAP 对接 SDK + 微信小程序前端',
    roles: [
      { r: '项目经理 (PM)', n: 1 },
      { r: 'AI 算法 (NLP + 规则)', n: 3 },
      { r: '后端 (ERP/SAP 对接)', n: 2 },
    ...
    benefits: [
      ...
      { icon: '🧬', t: '编码 AAAS 终身授权 + 跨行业可用', d: '服装 / 电子 / 汽车 / 家具 4 大行业 ERP 接入 · 终身免费用' },
      { icon: '💎', t: '未来营收分润权 2.5% + NFT 凭证', d: 'AAAS 系统对外服务期内 享 2.5% 营收分润（年营收预估 1500w+）按年兑付' },
      { icon: '🏭', t: '跨行业工厂参访', d: '法良上海宝山总部 + 6 智能工厂 + 跨行业标杆 私人导览' },
      { icon: '🌍', t: '欧洲品牌总部访问', d: '荷兰 KING LOUIE / 德国 WELLENSTEYN 总部行程 全包' },
      { icon: '🎁', t: '法良 × Crayxus 限量联名款', d: '棉羽 / 冲锋衣 创始版 1 套 (市场价 ~¥8000)' },
      { icon: '🎓', t: '东华纺织 + Crayxus 教授闭门课', d: '纺织 + AI 跨学科 私塾 8 节 · 含子女学习名额' }
    ]
  },
  {
    key: 'tripitaka',
    ...
    benefits: [
      ...
      { icon: '💎', t: '未来营收分润权 2% + NFT 凭证', d: 'AAAS 化对外授权期内 享 2% 营收分润 + 公益项目优先合作权' },
  ...
  },
  {
    ...
    benefits: [
      ...
      { icon: '💎', t: '未来营收分润权 2% + NFT 凭证', d: 'AAAS API + B 端授权 + 比赛场景应用 期内 享 2% 营收分润' },
  ...
  },
  {
    ...
    color: '#10b981',
    name: 'AI 氢能源生态大脑',
    short: '制氢 / 储氢 / 加氢站 / 燃料电池 全链 AAAS 调度',
    budget: 800,
    duration: 12,
    seats: 10,
    joined: 2,
    ...
    benefits: [
      { icon: '⚡', t: '氢能产业大脑 AAAS 终身席位', d: '可用于自有能源 / 物流 / 工业项目 · 终身使用' },
      { icon: '💎', t: '未来营收分润权 1.5% + NFT 凭证', d: '示范城市 AAAS 营收 + 加氢站调度费 期内 享 1.5% 分润' },
  ...
  },
  {
    ...
    perSeat: 12.5,
    seatUnit: '万',
    tagline: '1 个 AI 顶 5 人市场团队 · 朋友圈 / 小红书 / 抖音 / 视频号 / 社群 / 私域 全渠道自动出内容 + 自动跟单',
    painpoint: '中小企业老板想推广但养不起市场团队 — 6 个人月薪 6w + 外包月费 3w + 投流 5w = 一年烧 168w 还没声响。自己上手又不会写文案、不懂投流、不会跟客户。Crayxus AI 营销执行官 = 1 个 AI Agent 24×7 替代 5 人市场团队，自动选题、自动写文案、自动发布、自动接客户、自动跟单成交。',
    mechanism: 'AI 营销执行官三大能力：① **内容工厂** — 喂入产品资料 → AI 自动生成 30 条 / 周 朋友圈 / 小红书 / 抖音脚本 / 视频号封面 / 公众号长文，每个平台风格自动适配；② **矩阵号自动发布** — 接管 10+ 实名号 / 企业号，按时段、按热点、按话题自动排期发布，避免限流；③ **客户跟单自动化** — 评论区私信自动接待 + AI 客服深度对话 + 高意向客户自动同步给销售，全程链路追踪。',
    tech: 'DeepSeek V4 + 自训行业内容模型 + RPA 自动化 (Auto.js / Selenium) + 矩阵号反限流策略 + 客户旅程追踪 (CRM) + 多平台 API 整合 (微信 / 抖音开放平台 / 小红书 / 视频号) + 实时数据看板',
    roles: [
      { r: '项目经理 (PM)', n: 1 },
      { r: 'AI 内容算法 (NLP)', n: 2 },
      { r: 'RPA 自动化工程师', n: 1 },
    ...
    benefits: [
      { icon: '📣', t: 'AI 营销执行官 终身使用', d: '可用于自有产品 / 代理产品 / 多品牌矩阵 · 终身免费' },
      { icon: '💎', t: '未来营收分润权 2.5% + NFT 凭证', d: 'AAAS 系统对外服务期内 享 2.5% 营收分润（按年兑付）' },
      { icon: '🏭', t: '10+ 实名矩阵号资源传授', d: 'Crayxus 已养号 1-3 年的矩阵号 + 反限流操作手册' },
      { icon: '🎓', t: 'AI 营销操盘手 私塾', d: '12 节闭门课 · 内容算法 + 矩阵号运营 + 投流 ROI 实操 · 含子女' },
      { icon: '🤝', t: '跨行业客户资源池', d: '法良 26 国际品牌 + 浙商私董会 + Crayxus B 端客户 互推机会' },
      { icon: '🪪', t: '限量 8 席创始证书', d: 'NFT 数字证书 + 项目启动后享首席用户身份' }
    ]
  }
]
